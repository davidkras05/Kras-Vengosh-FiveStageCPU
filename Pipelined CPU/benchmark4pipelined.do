...
add wave -noupdate -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[0]}
add wave -noupdate -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[1]}
add wave -noupdate -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[2]}
add wave -noupdate -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[3]}
add wave -noupdate -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[4]}
add wave -noupdate -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[5]}
add wave -noupdate -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[6]}
add wave -noupdate -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[7]}
add wave -noupdate -expand -group MEMORY {/pipelined_tb/DUT/MEM/mem[0]}
add wave -noupdate -expand -group MEMORY {/pipelined_tb/DUT/MEM/mem[8]}
add wave -noupdate -expand -group MEMORY {/pipelined_tb/DUT/MEM/mem[16]}
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {251892 ps} 0}
...
update
WaveRestoreZoom {0 ps} {381901 ps}
