...
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/instruction
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/Db
...
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/Reg2Loc
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/ALUSrc
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/Mem2Reg
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/RegWrite
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/MemWrite
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/MemRead
add wave -noupdate -expand -group CNTRLS /pipelined_tb/DUT/control/BrTaken
...
add wave -noupdate -expand -group IF_ID -radix unsigned /pipelined_tb/DUT/firstpipeline/currPC
add wave -noupdate -expand -group IF_ID -radix unsigned /pipelined_tb/DUT/firstpipeline/PCp4
...
add wave -noupdate -expand -group ID -radix unsigned /pipelined_tb/DUT/instructionDecode/Immediate
add wave -noupdate -expand -group ID -radix unsigned /pipelined_tb/DUT/instructionDecode/DT_address
...
add wave -noupdate -expand -group ID -radix unsigned /pipelined_tb/DUT/instructionDecode/shift
...
add wave -noupdate -expand -group ID_EX /pipelined_tb/DUT/secondpipeline/Rd
add wave -noupdate -expand -group ID_EX /pipelined_tb/DUT/secondpipeline/Rn
add wave -noupdate -expand -group ID_EX /pipelined_tb/DUT/secondpipeline/Rm
...
add wave -noupdate -expand -group ID_EX -radix unsigned /pipelined_tb/DUT/secondpipeline/ALUInputOut
add wave -noupdate -expand -group ID_EX -radix unsigned /pipelined_tb/DUT/secondpipeline/RdOut
add wave -noupdate -expand -group ID_EX /pipelined_tb/DUT/secondpipeline/RnOut
add wave -noupdate -expand -group ID_EX /pipelined_tb/DUT/secondpipeline/RmOut
...
add wave -noupdate -expand -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[7]}
add wave -noupdate -expand -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[5]}
add wave -noupdate -expand -group Registers -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[6]}
add wave -noupdate -expand -group MEMORY -radix unsigned {/pipelined_tb/DUT/MEM/mem[0]}
add wave -noupdate -expand -group MEMORY -radix unsigned {/pipelined_tb/DUT/MEM/mem[8]}
add wave -noupdate -expand -group MEMORY -radix unsigned {/pipelined_tb/DUT/MEM/mem[16]}
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1612126 ps} 0}
...
update
WaveRestoreZoom {0 ps} {4672710 ps}
