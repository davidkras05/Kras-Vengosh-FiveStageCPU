...
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/MEM/mem[8]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/MEM/mem[0]}
...
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[10]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[9]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[8]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[7]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[6]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[5]}
...
WaveRestoreCursors {{Cursor 1} {3434418 ps} 0}
...
update
WaveRestoreZoom {3293567 ps} {3826212 ps}
