...
add wave -noupdate -group {FWDING UNIT} -radix unsigned /pipelined_tb/DUT/fwding_unit/RnIDEX
add wave -noupdate -group {FWDING UNIT} -radix unsigned /pipelined_tb/DUT/fwding_unit/RmIDEX
add wave -noupdate -group {FWDING UNIT} -radix unsigned /pipelined_tb/DUT/fwding_unit/RdEXMEM
add wave -noupdate -group {FWDING UNIT} -radix unsigned /pipelined_tb/DUT/fwding_unit/RdMEMWB
add wave -noupdate -group {FWDING UNIT} -radix binary /pipelined_tb/DUT/fwding_unit/RegWriteEXMEM
add wave -noupdate -group {FWDING UNIT} -radix binary /pipelined_tb/DUT/fwding_unit/RegWriteMEMWB
...
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[30]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[28]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[1]}
add wave -noupdate -radix unsigned {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[0]}
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {4739885 ps} 0}
