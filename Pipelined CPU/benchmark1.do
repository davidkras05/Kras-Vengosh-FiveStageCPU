...
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/Db
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/ZeroFlag
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/NegativeFlag
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/Reg2Loc
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/ALUSrc
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/Mem2Reg
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/RegWrite
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/MemWrite
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/MemRead
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/BrTaken
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/UncondBr
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/SetFlags
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/IsBL
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/IsBR
add wave -noupdate -expand -group Controls /pipelined_tb/DUT/control/isDType
...
WaveRestoreCursors {{Cursor 1} {211642 ps} 0}
...
update
WaveRestoreZoom {0 ps} {981316 ps}
