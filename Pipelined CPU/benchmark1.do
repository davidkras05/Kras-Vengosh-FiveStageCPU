...
add wave -noupdate -expand -group EX -radix decimal /pipelined_tb/DUT/execution/ALUOp
...
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/ALURes
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/ReadData2
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/Rd
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/MemtoReg
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/RegWrite
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/MemRead
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/MemWrite
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/IsBL
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/address
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/writeMemData
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/RdOut
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/MemtoRegOut
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/RegWriteOut
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/MemReadOut
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/MemWriteOut
add wave -noupdate -expand -group EX_MEM /pipelined_tb/DUT/thirdpipeline/IsBLOut
...
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/readMemData
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/ALURes
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/MemtoReg
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/RegWrite
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/IsBL
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/ALUResOut
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/readMemDataOut
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/MemtoRegOut
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/RegWriteOut
add wave -noupdate -expand -group MEM_WB /pipelined_tb/DUT/fourthpipeline/IsBLOut
add wave -noupdate -expand -group WB /pipelined_tb/DUT/writeBack/ALURes
add wave -noupdate -expand -group WB /pipelined_tb/DUT/writeBack/MEMData
add wave -noupdate -expand -group WB /pipelined_tb/DUT/writeBack/Mem2Reg
add wave -noupdate -expand -group WB -radix decimal /pipelined_tb/DUT/writeBack/WriteBck
...
add wave -noupdate -radix decimal {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[4]}
add wave -noupdate -radix decimal {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[3]}
add wave -noupdate -radix decimal {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[2]}
add wave -noupdate -radix decimal {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[1]}
add wave -noupdate -radix decimal {/pipelined_tb/DUT/instructionDecode/registerFile/reg_outs[0]}
...
update
WaveRestoreZoom {0 ps} {2054306 ps}
